...
interrupt_handler_%1: ; expand to interrupt_handler_0x01 for example
%ifn %2 ; if not
	push 0x20240419 ; error code for interrupt without error code
%endif
	push %1
	jmp interrupt_entry
%endmacro
...
INTERRUPT_HANDLER 0x05, 0 ; bound rage exceeded
...
INTERRUPT_HANDLER 0x2e, 0 ; harddisk1 disk master
INTERRUPT_HANDLER 0x2f, 0 ; harddisk2 disk slave
