...
#define KERNEL_BUFFER_ADDR 0x800000 // 8 MB
#define KERNEL_BUFFER_SIZE 0x400000 // 4 MB

#define KERNEL_RAMDISK_ADDR (KERNEL_BUFFER_ADDR + KERNEL_BUFFER_SIZE) // 12 MB
#define KERNEL_RAMDISK_SIZE 0x400000                                  // 4 MB
